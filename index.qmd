...
Visit my substack [here](https://genomicepi.substack.com/), or subscribe below

```{=html}
<iframe src="https://genomicepi.substack.com/embed" width="100%" height="300" style="border:1px solid #EEE; background:white;" frameborder="0" scrolling="no"></iframe>
```
